      ...
      {sessions.length ? (
        <>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-semibold">{feedbackNeededCount}</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            <CardHeader className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <CardDescription>
                  Click a session to view summary and open detail.
                </CardDescription>
              </div>
        ...
        <Empty className="min-h-80 border">
          <EmptyHeader>
            ...
            <EmptyDescription>
              Sessions appear after a member accepts your assignment and pays.
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
      )}
