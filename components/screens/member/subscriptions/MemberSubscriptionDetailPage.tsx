import { Check, CreditCard, UserCheck, X } from "lucide-react"
...
export async function MemberSubscriptionDetailPage({ subscriptionId }: Props) {
  ...
  return (
    <PageShell
      ...
      description="Complete PT setup, accept assignment, apply voucher, and pay."
            ...
            <Card>
              ...
              <CardContent className="grid gap-3 sm:grid-cols-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{money(subscription.base_price)}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">{money(subscription.final_price)}</p>
                </div>
              </CardContent>
            </Card>
                    ...
                    <div className="grid gap-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Fill the days you want to train. The number of filled
                          days becomes your sessions per week.
                        </p>
                      </div>
            ...
            {pendingAssignment ? (
              <Card>
                ...
                <CardContent className="grid gap-4">
                  <div className="rounded-lg border p-3">
                    <p className="font-medium">
                      {pendingAssignment.users?.full_name ??
                        "Trainer"}
                    </p>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    >
                      ...
                      <input type="hidden" name="assignmentId" value={pendingAssignment.id} />
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {acceptedAssignment.users?.full_name ??
                      "Trainer"}
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <div className="grid gap-4 content-start">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Apply a code before payment.</CardDescription>
              </CardHeader>
              <CardContent>
                <MemberActionForm action={applyVoucher} submitLabel="Apply voucher">
                  <input type="hidden" name="subscriptionId" value={subscription.id} />
                  <Input name="code" placeholder="MEMBERTEST10" />
                </MemberActionForm>
              </CardContent>
            </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <MemberActionForm
                    ...
                    submitLabel={`Pay ${money(subscription.final_price)}`}
                    pendingLabel="Paying"
                  >
                    <input type="hidden" name="subscriptionId" value={subscription.id} />
